...
import { 
  ...
  User, Trophy, LogOut, Hexagon, Zap, BookOpen
} from 'lucide-react';
...
export function Layout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    { href: '/dashboard', label: 'Dashboard', icon: Hexagon, exact: true },
    { href: '/aptitude', label: 'Aptitude', icon: BrainCircuit },
    { href: '/coding', label: 'Coding', icon: Code2 },
    { href: '/dictionary', label: 'Daily Words', icon: BookOpen },
    { href: '/puzzle', label: 'Puzzle Games', icon: Gamepad2 },
    { href: '/habits', label: 'Habit Tracker', icon: User },
