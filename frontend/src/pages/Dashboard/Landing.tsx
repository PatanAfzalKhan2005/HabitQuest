  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 pt-20 pb-32 flex flex-col items-center text-center">
        ...
        >
          Build your aptitude, conquer coding challenges, solve daily puzzles, and track streaks through a premium gamified learning journey.
        </motion.p>
      ...
      <AuthModal isOpen={authOpen} onClose={() => setAuthOpen(false)} />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-32 w-full max-w-5xl">
          {[
            { icon: Brain, title: "Aptitude Mastery", desc: "Simple, hard, and difficult levels with 12-question runs and animated results." },
            { icon: Code2, title: "Coding Challenges", desc: "Launch coding platforms, track progress, and stack streaks automatically." },
            { icon: Trophy, title: "Quest Rewards", desc: "Keep your habits, words, puzzles, and tests aligned inside one streak engine." }
          ].map((feature, i) => (
            <motion.div 
              key={i}
              initial={{ opacity: 0, y: 30 }}
