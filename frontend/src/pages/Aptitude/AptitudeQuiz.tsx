...
import { markAptitudeComplete } from '@/features/analytics/quest';
...
export function AptitudeQuiz() {
  ...
  const questions = data?.questions || [
    ...
    { id: 'q3', question: 'A train covers 120 km in 2 hours. What is the speed?', options: ['50 km/h', '60 km/h', '70 km/h', '80 km/h'], correctAnswer: '60 km/h', explanation: 'Speed = distance / time = 120 / 2.', topic: topicId, level },
    { id: 'q4', question: 'What is the average of 8, 10, 12?', options: ['9', '10', '11', '12'], correctAnswer: '10', explanation: 'Average = (8 + 10 + 12) / 3 = 10.', topic: topicId, level },
    { id: 'q5', question: 'If the ratio is 2:3 and the first number is 10, the second is?', options: ['12', '15', '18', '20'], correctAnswer: '15', explanation: 'Each part is 5, so 3 parts = 15.', topic: topicId, level },
    { id: 'q6', question: 'A shirt marked 1000 has 20% discount. Selling price?', options: ['700', '750', '800', '850'], correctAnswer: '800', explanation: '20% of 1000 is 200, so price is 800.', topic: topicId, level },
    { id: 'q7', question: 'Simplify 3/4 of 64.', options: ['24', '36', '48', '52'], correctAnswer: '48', explanation: '64 x 3 / 4 = 48.', topic: topicId, level },
    { id: 'q8', question: 'If 5 workers finish a job in 10 days, how many worker-days is it?', options: ['40', '45', '50', '60'], correctAnswer: '50', explanation: 'Work = workers x days = 5 x 10.', topic: topicId, level },
    { id: 'q9', question: 'Find the missing number: 4, 9, 16, 25, ?', options: ['30', '32', '36', '49'], correctAnswer: '36', explanation: 'These are squares: 2², 3², 4², 5², 6².', topic: topicId, level },
    { id: 'q10', question: 'Simple interest on 1000 at 10% for 2 years?', options: ['100', '150', '200', '250'], correctAnswer: '200', explanation: 'SI = PRT/100 = 1000 x 10 x 2 / 100.', topic: topicId, level },
    { id: 'q11', question: 'If 12 men can complete work in 15 days, 6 men take?', options: ['20 days', '25 days', '30 days', '35 days'], correctAnswer: '30 days', explanation: 'Men and days are inversely proportional.', topic: topicId, level },
    { id: 'q12', question: 'What is 30% of 150?', options: ['35', '40', '45', '50'], correctAnswer: '45', explanation: '30/100 x 150 = 45.', topic: topicId, level },
  ];
  ...
  const finishQuiz = async () => {
    try {
      ...
      // support different client shapes: some clients return { data: {...} }
      const responseData = res && typeof res === 'object' && 'data' in res ? (res as any).data : res;
      markAptitudeComplete({
        topic: topicId,
        level,
